...
public class PortWindow {
    ...
    public static void createPortWindow(SerialPortManager portManager, TextArea dataReceivedTextArea) {
        ...
        TextFlow infoNumberOfCollision = new TextFlow();
        ...
        dataToSendTextArea.setOnAction(actionEvent -> {
            ...
            infoNumberOfCollision.getChildren().clear();
            infoNumberOfCollision.getChildren().add(new Text(portManager.getNumberOfCollision().toString()));
        ...
        root.getChildren().addAll(dataToSendTextAreaLabel,
                ...
                new TextFlow(new Text("Data: ")),
                infoDataTransferTextFlow,
                new TextFlow(new Text("Encode data: ")),
                infoHammingEncodeTextFlow,
                new TextFlow(new Text("Error data: ")),
                infoHammingErrorTextFlow,
                new TextFlow(new Text("Decode data: ")),
                infoHammingDecodeTextFlow,
                new TextFlow(new Text("Collision attempt: ")),
                infoNumberOfCollision
        );
    ...
    private static void set(Integer a, Integer b) {
        b = a;
    }
